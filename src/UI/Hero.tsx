...
function Hero() {
  return (
    <div className="bg-[url(/assets/background.jpg)] bg-cover bg-center h-full flex flex-col items-start md:items-center md:justify-evenly gap-[60px] pt-15 text-white md:gap-0 md:pt-0 md:px-[100px]">
      ...
      <Button width="200px" height="50px" fontSize="25px">
        Order Now
      </Button>
    </div>
  );
